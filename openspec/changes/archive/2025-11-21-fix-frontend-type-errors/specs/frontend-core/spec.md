...
## Purpose
Defines the core infrastructure, utilities, and shared patterns for the frontend application, including API clients, authentication contexts, and type definitions.
